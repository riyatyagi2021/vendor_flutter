...
final themeColor = new Color(0xff7745e8);
      ...
      child:Scaffold(
        body: BlocConsumer<LoginBloc,LoginState>(
          listener:(context,state){
            if(state.isSuccess) {
              isLoading = false;
              var accessToken=state.model.responseData?.employeeProfile?.accessToken.toString();
              print(accessToken);
              LoginModel model=state.model;
              PreferenceUtils.setAccessToken(state.model.responseData!.employeeProfile!.accessToken.toString());
              PreferenceUtils.setUserProfile(state.model.responseData!.employeeProfile!);
              Navigator.push(
                  context,
                  MaterialPageRoute(
              ...
              isLoading = false;
              print(state.isError.toString()+ "  gdvbhsnkm,sdfdddddddddddsdfghbjnmk,");
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: const [
                                Icon(Icons.email_outlined,size: 20,color: COLOR.Black,),
                            ...
                            Form(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: AppUtils.BorderDecoration("Type Email"),
                                  onEditingComplete: () =>
                            ...
                            Row(
                              children: const [
                                Icon(Icons.lock_outlined,size: 20,color: COLOR.Black,),
                                const SizedBox(width: 10,),
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    suffixIcon: InkWell(
                                        ...
                                        child:  Icon(_isHidden?Icons.visibility_off:Icons.visibility,color: COLOR.Black,)),
